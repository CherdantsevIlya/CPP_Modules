...
{
//    std::cout << "MateriaSource constructor " << this << " called" << std::endl;
    for (int i = 0; i < 4; i++)
...
{
//    std::cout << "MateriaSource copy constructor " << this << " called" << std::endl;
    for (int i = 0; i < 4; i++)
    {
        if (other.material[i])
...
MateriaSource::~MateriaSource()
{
//    std::cout << "MateriaSource destructor " << this << " called" << std::endl;
    for (int i = 0; i < 4; i++)
        if (this->material[i])
